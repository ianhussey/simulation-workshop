...
# generate data from a null population effect (mu in 0 in both conditions)
generated_data <- 
...
# generate data from a medium population effect size
# e.g., sd = 1 in both conditions, difference in mu = 0.5, therefore cohen's d = 0.5
generated_data <- 
  sim_design(between = list(condition = c("control", "intervention")), 
             mu = c(0, 0.5),
             sd = 1, 
...
To detect small, medium, and large Cohen's d effect sizes, with sample sizes of 25, 50, 75, or 100 per condition.
